...
sphere2 = sphere([-450.0, -200.0, 1200.0], [200.0/255.0, 180.0/255.0, 100.0/255.0], 250.0)
...
def trace_ray(depth, camera_vect, ray_vect, obList):
	...
	if depth == 0:
		...
		if intersect_index == -1:
			final_rgb = [150.0/255.0, 150.0/255.0, 255.0/255.0] #We hit...nothing. So here's the sky.
		else:
